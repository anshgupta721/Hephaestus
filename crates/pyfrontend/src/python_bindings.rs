...
pub fn pysim_runner<'py>(
    ...
    dt: f64,
    seed: Option<u64>,
) -> PyResult<(Py<PyArray1<f64>>, Py<PyArray2<f64>>, Py<PyArray2<f64>>, Py<PyArray2<f64>>)> {
    ...
    // run the stepper
    let (t_hist, x_hist, u_hist, est_hist) = sim_stepper(x_0, u_0, t_span, dt, gnc);
